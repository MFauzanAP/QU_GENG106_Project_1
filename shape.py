...
class shape:
	...
	calculate_weight = lambda self : (self.input_props['width']['value'] / 1000) * (self.input_props['height']['value'] / 1000) * (self.input_props['length']['value'] / 1000) * self.input_props['density']['value']
